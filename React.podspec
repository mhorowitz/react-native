...
Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ...
    ss.exclude_files        = "**/__tests__/*", "IntegrationTests/*", "React/DevSupport/*", "React/Modules/RCTDev{LoadingView,Menu}.*", "React/**/RCTTVView.*", "ReactCommon/yoga/*", "React/Cxx*/*", "React/Base/RCTBatchedBridge.m", "React/Executors/*"
  ...
  s.subspec "BatchedBridge" do |ss|
    ...
    ss.source_files         = "React/Base/RCTBatchedBridge.m", "React/Executors/*"
  end
